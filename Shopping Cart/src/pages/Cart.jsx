...
const Cart = () => {
  ...
  //reduce function for sum of price of total no. items in the cart
  useEffect(() => {
      ...
      {cart.length > 0 ? (
        <div className="flex gap-16 max-w-6xl p-6 mx-auto flex-wrap lg:flex-nowrap">
          ...
          <div className="md:w-[30%] w-full flex flex-col gap-8 justify-between">
            <div className="mt-20">
              <h4 className="text-xl text-[#166534] uppercase font-[600]">
                Your Cart
              </h4>
              <h1 className="text-5xl font-[600] text-[#15803d] uppercase mb-4">
                Summary
              </h1>
